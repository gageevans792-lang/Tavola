...
const GROUPS: CommandGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'AutoPilot',                     href: '/autopilot',   description: 'Autonomous AI investing'              },
      ...
      { label: 'Trade History',                 href: '/trades',      description: 'View all past trades'                  },
      { label: 'Banking',                       href: '/bank',        description: 'Connect bank and set up recurring deposits' },
